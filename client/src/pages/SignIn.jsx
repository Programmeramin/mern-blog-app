...
const SignIn = () => {
 ...
 const handleSubmit = async (e) =>{
  ...
  if(!formData.email || !formData.password){
    return dispatch(signInFailed("Please fill all the fields"));
  }
      ...
      <div className="min-h-screen mt-20">
        <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5">
           ...
           <Link to="/" className=" text-sm sm:text-xl font-bold dark:text-white">
            ...
            <p className="text-2xl font-semibold mt-5">This is a demo project. You can sign in with your email and password or with Google </p>
           </div>
               ...
               <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                  ...
                  <div className="">
                   <Label value="Your password"/>
                     <TextInput type="text" placeholder="**********" id="password" onChange={handleInputChange}/>
                  </div>
                 ...
                 <div className="flex gap-2 text-sm mt-5">
                    <span>{`Do't have an account?`}</span>
